        ...
        static void Main(string[] args)
        {
            ...
            while (!bTimeOut)
            {
                ...
                if (sAnswer.ToUpper() == displayString && !bTimeOut)
                {
                    ...
                    Console.WriteLine($"Congratulations! Your score is: " + displayString.Length);
                }
                else
                {
                    // 9. otherwise display the correct code sequence and their final score (displayString.Length - 1)
                    Console.WriteLine("Timeout! The correct code sequence was: " + displayString + ". Your score was: " + displayString.Length);
